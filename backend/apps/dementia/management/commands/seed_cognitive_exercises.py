...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        exercises = [
            ...
            {
                'slug': 'real-face-recognition',
                'name_tr': 'Gerçek Yüz Tanıma',
                'name_en': 'Real Face Recognition',
                'description_tr': 'Gerçek insan fotoğraflarıyla yüz ve isim eşleştirme.',
                'description_en': 'Face and name matching with real human photos.',
                'instructions_tr': 'Size gerçek kişi fotoğrafları gösterilecek. Her kişinin yüzünü, ismini ve kim olduğunu ezberleyin. Ardından sorulan sorulara cevap verin.',
                'instructions_en': 'You will be shown real person photos. Memorize each person\'s face, name and relationship. Then answer the questions.',
                'exercise_type': 'memory',
                'difficulty': 'hard',
                ...
                'config': {
                    'face_counts': {'easy': 4, 'medium': 6, 'hard': 8},
                    'learn_time_per_face': 8,
                    'questions_per_face': 2,
                    'use_real_photos': True,
                },
            },

            # Navigation/Spatial Orientation Exercises
            {
                'slug': 'virtual-home-navigation',
                'name_tr': 'Ev İçi Navigasyon',
                'name_en': 'Virtual Home Navigation',
                'description_tr': 'Ev planında odalar arası yol bulma.',
                'description_en': 'Find your way between rooms in a house floor plan.',
                'instructions_tr': 'Bir ev planını inceleyeceksiniz. Sonra bir odadan diğerine giden en kısa yolu bulmanız istenecek.',
                'instructions_en': 'You will study a house floor plan. Then you will be asked to find the shortest path between rooms.',
                'exercise_type': 'orientation',
                'difficulty': 'medium',
                'estimated_duration_minutes': 7,
                'icon': 'home',
                'order': 17,
                'config': {
                    'learn_time': {'easy': 30, 'medium': 20, 'hard': 15},
                    'rounds': {'easy': 5, 'medium': 8, 'hard': 10},
                },
            },
            {
                'slug': 'map-reading',
                'name_tr': 'Harita Okuma',
                'name_en': 'Map Reading',
                'description_tr': 'Mahalle haritasında yön ve konum bulma.',
                'description_en': 'Find directions and locations on a neighborhood map.',
                'instructions_tr': 'Bir mahalle haritasını inceleyeceksiniz. Sonra yön ve konum sorularına cevap vereceksiniz.',
                'instructions_en': 'You will study a neighborhood map. Then you will answer direction and location questions.',
                'exercise_type': 'orientation',
                'difficulty': 'medium',
                'estimated_duration_minutes': 8,
                'icon': 'map',
                'order': 18,
                'config': {
                    'learn_time': {'easy': 45, 'medium': 30, 'hard': 20},
                    'rounds': {'easy': 6, 'medium': 8, 'hard': 12},
                },
            },
            {
                'slug': 'direction-following',
                'name_tr': 'Yön Takibi',
                'name_en': 'Direction Following',
                'description_tr': 'Verilen yönleri takip ederek hedefe ulaşma.',
                'description_en': 'Follow given directions to reach the target.',
                'instructions_tr': 'Size bir yön dizisi gösterilecek (yukarı, aşağı, sola, sağa). Yönleri ezberleyin ve sırayla takip ederek hedefe ulaşın.',
                'instructions_en': 'You will be shown a sequence of directions (up, down, left, right). Memorize them and follow in order to reach the target.',
                'exercise_type': 'orientation',
                'difficulty': 'easy',
                'estimated_duration_minutes': 6,
                'icon': 'compass',
                'order': 19,
                'config': {
                    'grid_size': {'easy': 4, 'medium': 5, 'hard': 6},
                    'sequence_length': {'easy': 3, 'medium': 4, 'hard': 5},
                    'rounds': {'easy': 5, 'medium': 7, 'hard': 10},
                },
            },
        ]
