        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea value={form.body_tr} onChange={e => setForm({...form, body_tr: e.target.value})} disabled={!canEdit}
              rows={12} className="w-full rounded-lg border px-3 py-2 text-sm font-mono disabled:bg-gray-50" />
          </div>
          <div>
            ...
            <textarea value={form.body_en} onChange={e => setForm({...form, body_en: e.target.value})} disabled={!canEdit}
              rows={6} className="w-full rounded-lg border px-3 py-2 text-sm font-mono disabled:bg-gray-50" />
          </div>
          {/* SEO */}
